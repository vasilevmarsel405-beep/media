...
- По умолчанию webhook уже работает в быстром режиме (только теги кеша). Если хотите принудить полный `revalidatePath`, задайте **`MAKE_WEBHOOK_LIGHT_REVALIDATE=0`**.
