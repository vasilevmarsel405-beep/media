...
export function TopBar() {
  return (
    <div className="bg-transparent">
      <div className="mx-auto flex max-w-[1400px] items-center px-3 pb-0 pt-[max(0.5rem,env(safe-area-inset-top))] sm:px-5 sm:pt-[max(0.5rem,env(safe-area-inset-top))] lg:px-10">
        <time
