  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-14 sm:px-6 lg:px-10">
        ...
        {tabs.map((t) => (
          <button
            ...
            className={`focus-ring rounded-xl px-4 py-2 text-sm font-semibold ${
              tab === t.id ? "bg-mars-ink text-white" : "bg-slate-100 text-slate-700 hover:bg-slate-200"
            }`}
          >
            {t.label}
          </button>
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        {tab === "profile" ? (
          <div className="space-y-4">
            ...
            <button
              type="button"
              className="rounded-xl bg-mars-accent px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-mars-accent-hover"
            >
      ...
      <p className="mt-8 text-sm text-slate-500">
        ...
        <Link href="/podpiska" className="font-semibold text-mars-blue hover:text-mars-accent hover:underline">
