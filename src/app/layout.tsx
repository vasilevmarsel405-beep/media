...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteName} — новости рынков, экономики и крипты`,
    template: `%s — ${siteName} | Экономика, политика и криптовалюты`,
  },
  description: metaCopy.description,
  keywords: [...metaCopy.topics, siteName],
  category: "news",
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName,
    title: `${siteName} — новости рынков, экономики и крипты`,
    description: metaCopy.description,
  },
  twitter: {
